...
public static void main(String[] args) throws InterruptedException
		     {
		 		...
		 		// Instantiate a ChromeDriver class.
		          ...
		          driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys("jithu");
		          driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys("gmjitendarkumar@gmail.com");
		         ...
		         // driver.switchTo().frame("auth-login-ui");
		          driver.findElement(By.xpath("//input[@class='sc-1yzxt5f-9 jucaYn']")).sendKeys("gmjitendarkumar@gmail");
